                                        ...
                                        <div class="col-md-3 <?php echo $rowDash['ArtefactColor'] ?> paddingL0">
                                            <div class="col-md-12 padding0">
                                                <div class="col-md-8 ">
                                                    ...
                                                    <span
                                                        class="tile-lbldesc">New <?php echo $rowDash['ArtefactTypeDescription']; ?></span>
                                                </div>
        ...
        <span u="arrowright" class="jssora03r" style="top: 123px; right: 8px;">
                    ...
                    <div class="col-md-12 padding0">
                        <div class="col-md-6 paddingL0">
                            ...
                            <a class="col-md-12 text-center pending-task-footer"
                               href="../schedule/scheduledMaintainence.php"
