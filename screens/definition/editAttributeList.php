            ...
            if ($value == 'NULL' || $value == NULL) {
                ...
                if (is_array($images)) {
                    ...
                    for ($i = 0; $i < sizeof($images); $i++) {
                        if ($images[$i]['type'] == 'jpg' || $images[$i]['type'] == 'png' || $images[$i]['type'] == 'tif' || $images[$i]['type'] == 'gif') {

                            $imagePath = $images[$i]['filepath'];
                            echo "<div class=''>";
                            echo "<a class='boxclose'></a>";
                            echo " <a class=''>
                                        <img src='$imagePath' data-toggle='context' data-target='#context-menu' class='img-thumbnail   imagegrid img-responsive' />
                                     </a>";
                            echo "</div>";
                        }
                    }
